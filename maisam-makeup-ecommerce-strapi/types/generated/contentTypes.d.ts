...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'banners';
    displayName: 'Banner';
    description: 'Banner items for the homepage';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiDrinkDrink extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'drinks';
    displayName: 'Drink';
    description: 'Drink items for the ecommerce store';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiIngredientIngredient extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    description: 'Ingredients for meals';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMealMeal extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'meals';
    displayName: 'Meal';
    description: 'Meal items for the ecommerce store';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'orders';
    displayName: 'Order';
    description: 'Orders containing meals and ingredients';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    paymentMethod: Schema.Attribute.Enumeration<['cash', 'card', 'online']> &
      Schema.Attribute.Required &
